...
public final class Benchmark1_test3 {
    ...
    public Collection<? extends Result> test3_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            Benchmark1_1_jmh l_benchmark10_G = _jmh_tryInit_f_benchmark10_G(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_benchmark10_G.test3();
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            test3_thrpt_jmhLoop(control, res, l_benchmark10_G, l_blackhole1_0);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "test3", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void test3_thrpt_jmhLoop(InfraControl control, RawResults result, Benchmark1_1_jmh l_benchmark10_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> test3_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            Benchmark1_1_jmh l_benchmark10_G = _jmh_tryInit_f_benchmark10_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            test3_avgt_jmhLoop(control, res, l_benchmark10_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "test3", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void test3_avgt_jmhLoop(InfraControl control, RawResults result, Benchmark1_1_jmh l_benchmark10_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> test3_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            Benchmark1_1_jmh l_benchmark10_G = _jmh_tryInit_f_benchmark10_G(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            test3_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_benchmark10_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_benchmark10_G.test3();
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "test3", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void test3_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Benchmark1_1_jmh l_benchmark10_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> test3_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            Benchmark1_1_jmh l_benchmark10_G = _jmh_tryInit_f_benchmark10_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            test3_ss_jmhStub(control, batchSize, res, l_benchmark10_G, l_blackhole1_0);
                control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "test3", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void test3_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Benchmark1_1_jmh l_benchmark10_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile Benchmark1_1_jmh f_benchmark10_G;
    
    Benchmark1_1_jmh _jmh_tryInit_f_benchmark10_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_benchmark10_G == null) {
                f_benchmark10_G = new Benchmark1_1_jmh();
            }
            if (!f_benchmark10_G.readyTrial) {
                f_benchmark10_G.readyTrial = true;
            }
        }
        return f_benchmark10_G;
    }
    ...
    static class Benchmark1_1_jmh_B1 extends test.Benchmark1 {
    ...
    static class Benchmark1_1_jmh_B2 extends Benchmark1_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Benchmark1_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Benchmark1_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Benchmark1_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Benchmark1_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Benchmark1_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Benchmark1_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class Benchmark1_1_jmh_B3 extends Benchmark1_1_jmh_B2 {
    ...
    static final class Benchmark1_1_jmh extends Benchmark1_1_jmh_B3 {
    }
